...
export class SeedmodelEffectsService {
    ...
    seedmodelAdd$: Observable<Action> = this.actions$
        ...
        .switchMap(payload => this.seedmodelService.addSeedmodel(payload)
    ...
    seedmodelUpdate$: Observable<Action> = this.actions$
        ...
        .map(action => action.payload)
        .switchMap(payload => this.seedmodelService.updateSeedmodel(payload)
    ...
    seedmodelLoadSingle$: Observable<Action> = this.actions$
        ...
        .map(action => action.payload)
        .switchMap(seedmodelKey => this.seedmodelService.getSingleSeedmodel(seedmodelKey)
